...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sistema Grupo Mandotti" },
      {
        name: "description",
        content: "Plataforma interna de gestão agrícola do Grupo Mandotti.",
      },
      { name: "author", content: "Grupo Mandotti" },
      { property: "og:title", content: "Sistema Grupo Mandotti" },
      {
        property: "og:description",
        content: "Plataforma interna de gestão agrícola do Grupo Mandotti.",
      },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "/favicon-512.png?v=3" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:image", content: "/favicon-512.png?v=3" },
      { name: "theme-color", content: "#037638" },
    ...
    links: [
      ...
      { rel: "mask-icon", href: "/safari-pinned-tab.svg?v=3", color: "#037638" },
